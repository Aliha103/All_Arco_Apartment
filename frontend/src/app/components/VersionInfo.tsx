...
const updates = [
  {
    ...
    date: 'November 2025',
    icon: Shield,
    title: 'Enhanced Security & Profile Updates',
    changes: [
      'Unique secure UserId (6-digit cryptographic hash)',
      'Enhanced profile page with full accessibility',
      'Complete mobile responsiveness (320px-1280px+)',
      'Touch optimization (44px minimum targets)',
      'Keyboard navigation (Escape, Tab, auto-focus)',
      'WCAG AA compliance with ARIA labels',
      'Discord-style navigation dropdown',
      'Professional profile settings at /profile/settings',
    ],
  },
  {
    version: '1.1.4',
