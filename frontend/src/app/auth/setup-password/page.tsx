...
import {
  Mail, Lock, ArrowRight, Eye, EyeOff, CheckCircle, AlertCircle, KeyRound, UserPlus
} from 'lucide-react';
...
function SetupPasswordContent() {
  ...
  const validateForm = () => {
    ...
    if (code.length !== 6) {
      setError('Setup code must be 6 digits');
      return false;
    }
    if (!newPassword) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Uses the same password reset confirm endpoint
      ...
      const errorMessage = err.response?.data?.error || 'Failed to set up password. Please try again.';
            ...
            <>
              ...
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-[#C4A572]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <UserPlus className="w-8 h-8 text-[#C4A572]" />
                </div>
                <h2 className="text-3xl font-light text-white mb-2">
                  Set Up Your Account
                </h2>
                <p className="text-gray-500">
                  Enter your setup code from the invitation email and create your password
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1.5">
                    Check your invitation email for the 6-digit code
                  </p>
                </div>
                ...
                <div className="text-center pt-2 text-sm">
                  <p className="text-gray-500">
                    ...
                    <Link
                      ...
                      className="text-[#C4A572] hover:underline"
                    >
                      Contact support
                    </Link>
                  </p>
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Your password has been set successfully. You can now log in to the PMS with your credentials.
                </p>
              </div>
